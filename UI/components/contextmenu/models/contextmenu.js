...
uni.observe("component:contextmenu:loaded", function(comp) {
    ...
    //_global.activeId = _global.activeId || "global-context-menu"
	...
	$.fn.contextmenu = function(id, options){
        ...
        if(!_global.menuClass)_global.menuClass = 'contextmenu';
        ...
        $('#' + id).find('li').unbind('.contextmenu').bind('mouseover.contextmenu', function(e){  
        ...
        if(!eventType)
        {
            eventType = $.browser.opera ? _menus[id].operaEvent + '.contextmenu' : 'contextmenu.contextmenu';
        }
        else
        {
        ...
        return $(this).bind(eventType, function(e){
			...
			$(document).bind('mouseover.contextmenu', function(e){ 
